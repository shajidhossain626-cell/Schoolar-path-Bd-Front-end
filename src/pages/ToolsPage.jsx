...
const TOOLS = [
  ...
  },
  {
    ...
    desc: 'Paste your Statement of Purpose draft — get an instant score, readability analysis, and specific suggestions to strengthen it.',
    badge: 'Coming Soon',
    badgeColor: '#f59e0b',
    time: '2 minutes',
    users: '',
  ...
  },
  {
    ...
    desc: 'Choose a country and city — see your estimated monthly living cost breakdown including rent, food, transport, and insurance.',
    badge: 'Coming Soon',
    badgeColor: '#f59e0b',
    time: '1 minute',
    users: '',
  ...
  },
  {
    ...
    desc: 'Convert your CGPA to the 4.0 GPA scale, percentage, or UK grade classification — instantly and accurately.',
    badge: 'Coming Soon',
    badgeColor: '#f59e0b',
    time: '10 seconds',
    users: '',
